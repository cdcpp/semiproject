...
<div class="section">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h2><span class="label label-danger">바지</span></h3>
			</div>
		</div>
	
	
		<div class="row">
		<c:if test="${bottomList==null || empty bottomList}">
			<div class="col-md-3">
				<h3>상품 준비 중</h3>
			</div>
		</c:if>
		<c:if test="${bottomList !=null && not empty bottomList }">
			<c:forEach var="pd" items="${bottomList}" varStatus="status">        
