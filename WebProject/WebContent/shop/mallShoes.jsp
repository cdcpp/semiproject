...
<div class="section">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h2><span class="label label-danger">신발</span></h3>
			</div>
		</div>
	
	
		<div class="row">
		<c:if test="${shoesList==null || empty shoesList}">
			<div class="col-md-3">
				<h3>상품 준비 중</h3>
			</div>
		</c:if>
		<c:if test="${shoesList !=null && not empty shoesList }">
			<c:forEach var="pd" items="${shoesList}" varStatus="status">        
