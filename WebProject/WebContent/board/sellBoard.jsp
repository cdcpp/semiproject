...
<%String myctx=request.getContextPath();%>  
  <jsp:include page="/top.jsp" />    
   <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <li><a href="sellBoard.do?cpage=${cpage-1}">prev</a></li>
           
           <c:forEach var="i" begin="${sp}" end="${ep}">
           
            
		   		<li <c:if test="${cpage eq i}">class='active'</c:if> >
		   			<a href="sellBoard.do?cpage=${i}">${i}</a>
		   		</li>
		   		
		   		</c:forEach>
		   		
		   		 <li><a href="sellBoard.do?cpage=${cpage+1}">next</a></li>
    ...
    <div id="searchForm">
      <form class="text-center" action="searchBoard.do?">
        <select name="opt">
